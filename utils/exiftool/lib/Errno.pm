...
"MSWin32-x64-multi-thread-10.0.17134.407" or
	die "Errno architecture (MSWin32-x64-multi-thread-10.0.17134.407) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAEPROVIDERFAILEDINIT WSAEINVAL WSAEINPROGRESS WSAEREFUSED
	WSAESHUTDOWN WSAESTALE WSAENOTCONN WSAEALREADY WSAEINTR
	WSAECONNABORTED WSAECONNRESET WSAENOTEMPTY WSAENOMORE WSAEREMOTE
	WSAEUSERS WSAENETDOWN WSAENOTSOCK WSAENETRESET WSAEWOULDBLOCK
	WSAEFAULT WSAETOOMANYREFS WSAEHOSTUNREACH WSAEDQUOT WSAEDISCON
	WSAECONNREFUSED WSAEPROTOTYPE WSAEHOSTDOWN WSAENAMETOOLONG
	WSAENETUNREACH WSAEPFNOSUPPORT WSAEMFILE WSAELOOP WSAEPROTONOSUPPORT
	WSAEACCES WSAETIMEDOUT WSAEAFNOSUPPORT WSAEBADF WSAEADDRINUSE
	WSAENOPROTOOPT WSAEMSGSIZE WSAEDESTADDRREQ WSAESOCKTNOSUPPORT
	WSAENOBUFS WSAECANCELLED WSAEADDRNOTAVAIL WSAEPROCLIM
	WSAEINVALIDPROCTABLE WSAEOPNOTSUPP WSAEISCONN WSAEINVALIDPROVIDER
    )],
);
