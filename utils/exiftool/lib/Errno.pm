...
"MSWin32-x64-multi-thread-10.0.17763.529" or
	die "Errno architecture (MSWin32-x64-multi-thread-10.0.17763.529) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAEAFNOSUPPORT WSAETOOMANYREFS WSAENETRESET WSAEHOSTDOWN WSAEALREADY
	WSAENOTEMPTY WSAENOBUFS WSAECONNRESET WSAEPROVIDERFAILEDINIT
	WSAENAMETOOLONG WSAEINVAL WSAEDISCON WSAEMSGSIZE WSAEDQUOT
	WSAENETUNREACH WSAEREFUSED WSAEHOSTUNREACH WSAEPROTONOSUPPORT WSAEBADF
	WSAENOPROTOOPT WSAEINVALIDPROCTABLE WSAEREMOTE WSAENETDOWN WSAEACCES
	WSAEADDRNOTAVAIL WSAENOMORE WSAEWOULDBLOCK WSAEUSERS WSAEMFILE
	WSAEINVALIDPROVIDER WSAEINTR WSAEFAULT WSAESOCKTNOSUPPORT WSAENOTCONN
	WSAEDESTADDRREQ WSAESTALE WSAESHUTDOWN WSAEOPNOTSUPP WSAEPROCLIM
	WSAEADDRINUSE WSAECONNABORTED WSAEISCONN WSAECONNREFUSED WSAECANCELLED
	WSAEINPROGRESS WSAEPFNOSUPPORT WSAETIMEDOUT WSAEPROTOTYPE WSAENOTSOCK
	WSAELOOP
    )],
);
